<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Tablets.aspx.cs" Inherits="Medion.Tablets" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form1" runat="server">
        <h1>&nbsp</h1>
        <asp:DataList ID="DataList1" runat="server" Style="background-color: #D8DADC; border-radius: 5px; gap: 10px; display: flex; flex-direction: row; margin: auto; flex-wrap: wrap; justify-content: space-between; align-items: center" OnItemCommand="DataList1_ItemCommand" OnSelectedIndexChanged="DataList1_SelectedIndexChanged" RepeatColumns="3" Width="70%" RepeatDirection="Horizontal">
            <ItemTemplate>
